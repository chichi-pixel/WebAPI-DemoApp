...
{
    /// <summary>
    /// This is where I give you all the Information about peeps.
    /// </summary>
    public class PeopleController : ApiController
    {
        ...
        {
            people.Add(new Person { FirstName = "Tonny", LastName = "Corn", Id = 1 });
            people.Add(new Person { FirstName = "Sue", LastName = "Storm", Id = 2 });
            people.Add (new Person { FirstName = "Bilbo", LastName = "Baagin", Id = 3 });
        }
